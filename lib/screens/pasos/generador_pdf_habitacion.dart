          ...
          pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                // 🔹 Aquí quitamos el nombreHotel pero mantenemos el espacio
                pw.SizedBox(height: 52), // (22 del texto + 30 del espacio original)
...
List<pw.Widget> _condicionesGenerales(
  ...
  final condiciones = [
    ...
    },
    {
      ...
      'contenido': '- Check-in: Desde las 14:00 hrs.\n- Check-out: Hasta las 11:00 hrs.'
    },
    {
